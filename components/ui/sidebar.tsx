...
// import { Sheet, SheetContent } from "@/components/ui/sheet" // Sheet not installed, fallback to simple div for mobile
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "[[data-side=left]_&]:bg-sidebar/0 [[data-side=right]_&]:bg-sidebar/0", // Transparent by default
                className
            )}
            {...props}
        />
