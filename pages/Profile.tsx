...
// Data derived from Home.tsx fallbackDepartmentsData
const DEPARTMENT_DATA = [
  {
    name: '信息工程学部',
    majors: ['软件工程', '计算机科学与技术', '数据科学与大数据技术', '物联网工程', '人工智能']
  },
  {
    name: '医学部',
  ...
  {
    name: '经济与管理学部',
    majors: ['会计学', '市场营销', '财务管理', '国际经济与贸易', '电子商务']
  },
  {
    name: '艺术与设计学部',
    majors: ['环境设计', '视觉传达设计', '数字媒体艺术', '产品设计']
  },
  {
    name: '城建学部',
    majors: ['土木工程', '工程造价', '城乡规划', '给排水科学与工程']
  },
  {
    name: '外语学部',
    majors: ['英语翻译', '商务英语', '日语']
  ...
  {
    name: '机电工程学部',
    majors: ['机械自动化', '电气工程及其自动化', '工业机器人技术']
  },
  {
    name: '汽车与电子工程',
    majors: ['车辆工程', '新能源汽车工程', '电子信息工程', '通信工程']
  }
];
